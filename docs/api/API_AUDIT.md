...
> 审计日期：2026-09-05  
> 范围：`docs/api/`、`src/app/api/`、`src/contracts/`、`src/contracts/route-manifest.ts` 与对应的 local mock Route Handler；本轮同时补充 compose task 的 project/canvas scope 与 reset-generation 运行时闭环。
