...
| 类型、单元、交互和视觉验证 | Typecheck/lint、986 单测、当前核心 suite 已列入 Script V2、Storyboard/video-editor handoff 与 Clip Editor deterministic journey，另有既有 1440×900 基线；TV Show media metadata 截图竞态已由连续 20 次回归覆盖。 | **持续验证中** | 对新增 Clip Editor core 跑完整隔离 suite，并补齐素材拖放/预览/导出的视觉基线；当前绿色测试不能证明尚未实现的能力。 |
