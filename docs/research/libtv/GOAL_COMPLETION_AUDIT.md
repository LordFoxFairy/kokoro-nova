...
| 类型、单元、交互和视觉验证 | Typecheck/lint、141 个 Vitest 文件/1077 个测试、当前核心 suite 已列入 Script V2、Storyboard/video-editor handoff、Clip Editor deterministic journey 与 seeded mixed-media journey，另有既有 1440×900 基线；首页动画 banner 的 visual contract 已固定到提交的首帧 fixture。 | **持续验证中** | 对新增 Clip Editor core 跑完整隔离 suite，并补齐 local export success/failed visual states；当前绿色测试不能证明尚未实现的能力。 |
