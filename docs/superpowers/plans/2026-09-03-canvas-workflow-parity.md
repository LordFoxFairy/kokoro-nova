...
- [x] The editor has no runtime dependency on `liblib.tv`, `liblib.art` or `liblib.cloud`.
- [x] Existing workflow mutations, generation state machine, revision conflict handling, undo/redo and E2E journeys remain unchanged.
- [x] Workflow and storyboard continue to render the same `WorkflowDocument`; switching views issues no document API write.
- [x] All interactive icon-only controls have an accessible name and visible hover/focus feedback.
- [x] Every floating surface remains keyboard dismissible and inside the `1440×900` viewport.
- [x] Editor tokens are scoped to `[data-app-shell='editor']`; home/project visuals must not regress.
...
- [x] **Step 1: Add an empty-canvas geometry test**
...
- [x] **Step 2: Add add-menu taxonomy and keyboard assertions**
...
- [x] **Step 3: Add storyboard layout assertions**
...
- [x] **Step 1: Introduce editor-only color, border and shadow tokens**
...
- [x] **Step 1: Recompose the left identity control**
...
- [x] **Step 2: Make the view switch current and accessible**
...
- [x] **Step 3: Add observed right-side hierarchy**
...
- [x] **Step 4: Match switcher menu states**
...
- [x] **Step 1: Match bottom control geometry**
...
- [x] **Step 2: Match current add-menu labels and order**
...
- [x] **Step 3: Preserve add-resource behavior**
...
- [x] **Step 4: Rebuild the empty starter strip**
...
- [x] **Step 1: Restyle media nodes at common zoom levels**
...
- [x] **Step 2: Match handles and edges**
...
- [x] **Step 1: Match column projection**
...
- [x] **Step 5: Run storyboard and Agent tests and commit**
...
- [x] **Step 3: Update the feature matrix**
...
Verified on 2026-09-03: `pnpm verify` passed 29 Vitest files / 500 tests and the production build; `pnpm e2e` passed all 39 applicable Playwright tests, with the two production-only cases skipped by the development configuration.
