...
export const SCENARIO_CATALOG: Record<ScenarioId, ScenarioMeta> = {
  ...
  'video-awaiting-confirmation': meta('video-awaiting-confirmation', '视频等待确认（过期报价）', '视频报价已生成但已过期，用于验证重新报价保护。'),
  'video-awaiting-valid-confirmation': meta(
    'video-awaiting-valid-confirmation',
    '视频等待确认（有效报价）',
    '视频报价仍有效，用于验证确认扣费、忙碌锁定和进入队列。',
  ),
