...
function imageArtifact(): Artifact {
  return {
    ...
    jobId: IMAGE_JOB_ID,
    kind: 'image',
    url: '/fixtures/libtv/media/first-frame.svg',
    thumbnailUrl: '/fixtures/libtv/media/first-frame.svg',
    width: 1920,
    height: 1080,
...
function videoArtifact(): Artifact {
  return {
    ...
    jobId: VIDEO_JOB_ID,
    kind: 'video',
    url: '/fixtures/libtv/media/city-night.mp4',
    thumbnailUrl: '/fixtures/libtv/media/city-night-poster.svg',
    width: 1280,
    height: 720,
    durationSeconds: 10,
    createdAt: isoAt(-60),
  ...
  return node(
    ...
    { width: 400, height: 300 },
    {
      ...
      extra: {
        ...
        advanced: { webSearch: true, autoCompliance: true },
        cameraMove: '缓慢推进',
        effect: null,
      },
    },
...
function videoJob(status: VideoScenarioStatus): GenerationJob {
  return {
    ...
    spec: {
      ...
      inputs: [
        { kind: 'image', value: '/fixtures/libtv/media/first-frame.svg', fromNodeId: 'node_image_01' },
  ...
  const nodes: WorkflowNode[] = [
    ...
    node(
      ...
      { width: 420, height: 260 },
      {
        ...
        jobId: null,
        extra: {
          timeline: status === 'succeeded' ? [{ id: 'clip_video_01', artifactId: 'art_video_01', start: 0, end: 10 }] : [],
          transitions: [],
          subtitles: [],
        },
      },
